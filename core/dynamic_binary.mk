...
$(warning LOCAL_UNSTRIPPED_PATH == $(LOCAL_UNSTRIPPED_PATH))
...
$(warning linked_module == $(linked_module))
...
$(warning compress_output == $(compress_output))
endif
...
$(warning symbolic_output == $(symbolic_output))
...
$(warning strip_output == $(strip_output))
...
# Strip the binary
ifeq ($(LOCAL_STRIP_DEPEND),true)
$(strip_output): $(strip_input) | $(TARGET_STRIP)
	$(transform-to-stripped)
else
$(strip_output): $(strip_input)
	$(transform-to-stripped)
endif # LOCAL_STRIP_DEPEND

else # LOCAL_STRIP_MODULE
