...
$(shell test -d device && find device -maxdepth 6 -name $(TARGET_PRODUCT_MAKEFILE)) \
  $(shell test -d vendor && find vendor -maxdepth 6 -name $(TARGET_PRODUCT_MAKEFILE)) \
  $(SRC_TARGET_DIR)/product/$(TARGET_PRODUCT_MAKEFILE)
endef
